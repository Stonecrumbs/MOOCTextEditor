...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> words = getTokens("(?i)[a-z^a-z]+ *");
	...
	public int getNumSentences()
	{
		...
		//List<String> sentences = getTokens("(?i)[a-z0-9 ,:()]+\\.+|[a-z0-9 ,:()]+!+|[a-z0-9 ,:()]+\\?+|[a-z0-9 ,:()]+");
		List<String> sentences = getTokens("(?i)[^.!?]+\\.+|[^.!?]+\\?+|[^.!?]+\\!+|[^.!?]+");
	...
	public int getNumSyllables()
	{
		...
		//List<String> syllables = getTokens("(?i)(ai|au|ea|ee|ei|eu|ie|io|oa|oe|oi|oo|ou|ue|ui|y[^aeiou])|[aeiouy]+(?:[^aeiouy]*e\\b)?");
		int numSyllables = 0;
		List<String> words = Arrays.asList(getText().split(" +"));
		String singleWord = "";
		for (String word: words){

			singleWord = word.replaceAll("[^a-zA-Z]", "");

			//System.out.println(singleWord+" "+countSyllables(singleWord));
			numSyllables += countSyllables(singleWord);
		}
